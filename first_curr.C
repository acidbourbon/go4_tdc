...
void first()
{
  //base::ProcMgr::instance()->SetRawAnalysis(true);
   ...
   hadaq::TrbProcessor::SetDefaults(17, 2);
//    hadaq::TdcProcessor::SetDefaults(1000);
   ...
   hadaq::TrbProcessor::SetTDCRange(0x1483, 0x1483);
   //hadaq::T
...
//printf("FineTime: %d\n", tdc->fCh[0].rising_hit_tm);
      //tdc->SetDefaults(1000,10000);
    // tdc->DisableCalibrationFor(0,8);
      /*tdc->SetLinearCalibration(1, 5, 506);
      tdc->SetLinearCalibration(2, 4, 506);
      tdc->SetLinearCalibration(3, 5, 500);
      tdc->SetLinearCalibration(4, 3, 504);
      tdc->SetLinearCalibration(5, 1, 508);
      tdc->SetLinearCalibration(6, 3, 509);
      tdc->SetLinearCalibration(7, 2, 498);
      tdc->SetLinearCalibration(8, 5, 498);
      tdc->SetLinearCalibration(9, 16, 507);
      tdc->SetLinearCalibration(10, 16, 486);
      tdc->SetLinearCalibration(11, 16, 492);
      tdc->SetLinearCalibration(12, 16, 496);
	...
	tdc->SetRefChannel(0,0, 0x1000, 20000, -10, 10); // LED DIFF
	tdc->SetRefChannel(1,3, 0x1000, 20000, -17000, 17000); // LED DIFF
	tdc->SetRefChannel(2,1, 0x1000, 20000, -50, 50); // LED DIFF
	tdc->SetRefChannel(3,2, 0x1000, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(4,1, 0x1000, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(5,4, 0x1000, 20000, -50, 50); // LED DIFF
  /*tdc->SetRefChannel(6,2, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(7,1, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(8,1, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(9,7, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(10,5, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(11,9, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(12,1, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(13,2, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(14,4, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(15,12, 0x0203, 20000, -50, 50); // LED DIFF
  tdc->SetRefChannel(16,6, 0x0203, 20000, -50, 50); // LED DIFF
*/
      }
